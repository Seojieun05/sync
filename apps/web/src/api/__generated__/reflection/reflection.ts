...
>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: experienceId !== null && experienceId !== undefined,
    ...queryOptions,
...
export type getReflectionActivitiesResponse200 = {
  data: GetReflectionActivitiesResponse;
  status: 200;
};

export type getReflectionActivitiesResponseSuccess =
  getReflectionActivitiesResponse200 & {
    headers: Headers;
  };
export type getReflectionActivitiesResponse =
  getReflectionActivitiesResponseSuccess;

export const getGetReflectionActivitiesUrl = (
  handle: string,
  params: GetReflectionActivitiesParams,
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/profiles/${handle}/reflections/activities?${stringifiedParams}`
    : `/profiles/${handle}/reflections/activities`;
};
 ...
 */
export const getReflectionActivities = async (
  handle: string,
  params: GetReflectionActivitiesParams,
  options?: RequestInit,
): Promise<getReflectionActivitiesResponse> => {
  return api<getReflectionActivitiesResponse>(
    getGetReflectionActivitiesUrl(handle, params),
    {
      ...options,
      method: 'GET',
    },
...
export const getGetReflectionActivitiesQueryKey = (
  handle: string,
  params?: GetReflectionActivitiesParams,
) => {
  return [
...
export const getGetReflectionActivitiesQueryOptions = <
  TData = Awaited<ReturnType<typeof getReflectionActivities>>,
  TError = ErrorType<unknown>,
>(
  handle: string,
  params: GetReflectionActivitiesParams,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getReflectionActivities>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetReflectionActivitiesQueryKey(handle, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getReflectionActivities>>
  > = ({ signal }) =>
    getReflectionActivities(handle, params, { signal, ...requestOptions });
...
export type GetReflectionActivitiesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getReflectionActivities>>
>;
export type GetReflectionActivitiesQueryError = ErrorType<unknown>;

export function useGetReflectionActivities<
  TData = Awaited<ReturnType<typeof getReflectionActivities>>,
  TError = ErrorType<unknown>,
>(
  handle: string,
...
export type CreateReflectionMutationResult = NonNullable<
  Awaited<ReturnType<typeof createReflection>>
>;
export type CreateReflectionMutationBody = CreateReflectionRequest | undefined;
...
export type UpdateReflectionMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateReflection>>
>;
export type UpdateReflectionMutationBody = UpdateReflectionRequest | undefined;
...
export type searchReflectionsResponse200 = {
  data: SearchReflectionsResponse;
  status: 200;
};

export type searchReflectionsResponseSuccess = searchReflectionsResponse200 & {
  headers: Headers;
};
export type searchReflectionsResponse = searchReflectionsResponseSuccess;

export const getSearchReflectionsUrl = (params: SearchReflectionsParams) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/search/reflections?${stringifiedParams}`
    : `/search/reflections`;
};

/**
 * Search Reflections by query string
...
export const searchReflections = async (
  ...
  return api<searchReflectionsResponse>(getSearchReflectionsUrl(params), {
    ...options,
    method: 'GET',
  });
};

export const getSearchReflectionsQueryKey = (
  params?: SearchReflectionsParams,
) => {
  return [`/search/reflections`, ...(params ? [params] : [])] as const;
};

export const getSearchReflectionsQueryOptions = <
  TData = Awaited<ReturnType<typeof searchReflections>>,
  TError = ErrorType<unknown>,
>(
  params: SearchReflectionsParams,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getSearchReflectionsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof searchReflections>>
  > = ({ signal }) => searchReflections(params, { signal, ...requestOptions });
...
export type SearchReflectionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof searchReflections>>
>;
export type SearchReflectionsQueryError = ErrorType<unknown>;

export function useSearchReflections<
  TData = Awaited<ReturnType<typeof searchReflections>>,
  TError = ErrorType<unknown>,
>(
  params: SearchReflectionsParams,
...
>(
  ...
  const queryOptions = getSearchReflectionsQueryOptions(params, options);
